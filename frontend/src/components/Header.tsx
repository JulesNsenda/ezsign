 ...
 * Implements WAI-ARIA menu button pattern for accessibility
 */
...
export const Header: React.FC<HeaderProps> = ({ onMenuToggle }) => {
  ...
  useEffect(() => {
    ...
    // Focus the logout button when menu opens
    ...
    <header className="bg-base-100 border-b border-base-300 sticky top-0 z-30 shadow-sm">
      <div className="flex justify-between items-center px-4 lg:px-6 py-4">
        <div className="flex items-center gap-4">
          ...
          >
            <svg className="w-6 h-6 text-base-content" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            {resolvedTheme === 'light' ? (
              <svg className="w-5 h-5 text-base-content" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div className="relative">
            ...
            >
            <div className="w-8 h-8 rounded-full bg-gradient-to-br from-neutral to-neutral/80 text-base-100 flex items-center justify-center font-semibold text-sm shadow-sm" aria-hidden="true">
          ...
          {isMenuOpen && (
            <>
              ...
              <div
                ...
                className="absolute top-full right-0 mt-2 bg-base-100 border border-base-300 rounded-xl shadow-xl min-w-[220px] z-50 animate-slide-down overflow-hidden"
              >
                <div className="px-4 py-3 border-b border-base-300 bg-base-200/30" role="none">
